          ...
          <div style={{ display: "flex", height: "calc(100vh - 52px)" }}>
            ...
            <div style={{ width: 258, borderRight: "1px solid #161820", flexShrink: 0, display: "flex", flexDirection: "column", overflow: "hidden" }}>
              <div style={{ padding: "16px 18px 14px", borderBottom: "1px solid #161820" }}>
                ...
                {plan === "pro" && (
                  <button onClick={exportCSV} style={{ marginTop: 9, background: "none", border: "1px solid #1a1d26", color: "#444", fontFamily: "inherit", fontSize: 9, padding: "4px 10px", borderRadius: 3, cursor: "pointer", letterSpacing: "0.08em", transition: "all 0.15s" }}
                    ...
                    return (
                      <>
                        ...
                        <div className="card" style={{ marginBottom: 12 }}>
                          <div style={{ fontSize: 8, color: "#444", textTransform: "uppercase", letterSpacing: "0.12em", marginBottom: 12 }}>Andamento Prezzo — 30 giorni</div>
